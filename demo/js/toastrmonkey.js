 ...
 * ToastrMonkey
 * Version 1.0.0
 * Copyright 2016 Mian Muhammad.  
 * All Rights Reserved.  
 * Use, reproduction, distribution, and modification of this code is subject to the terms and 
 * conditions of the MIT license, available at http://www.opensource.org/licenses/mit-license.php
 *
 * Author: Mian Muhammad Asif Akhtar
 * Project: https://github.com/mianmohammad/monkeytoaster
 */
...
; (function (define) {
    define(['jquery'], function ($) {
        return (function () {
            ...
            function getDefaultOptions() {
                return {
                    tapToDismiss: true,
                    toastClass: 'toastmonkey',
                    containerId: 'toastmonkey-container',
                    debug: false,
                    closeButton: true,
                    ...
                    iconClass: 'toastmonkey-info',
                    positionClass: 'toastmonkey-bottom-right',
                    timeOut: 5000, // Set timeOut and extendedTimeout to 0 to make it sticky
                    titleClass: 'toastmonkey-title',
                    messageClass: 'toastmonkey-message',
                    leftBlockClass: 'toastmonkey-avatar-container',
                    centerBlockClass: 'toastmonkey-message-container',
                    rightBlockClass: 'toastmonkey-right-container',
                    target: 'body',
                    closeHtml: "<button class='toastmonkey-close-button'>×</button>",
                    newestOnTop: true
                };
            }
    ...
    if (typeof window.module !== 'undefined' && window.module.exports) { //Node
        ...
        window.toastrmonkey = factory(window['jQuery']);
    }
}));
